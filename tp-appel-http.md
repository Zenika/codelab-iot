...
![historique](resources/tp-appel-http-historique.jpg)
...
[{{ site.code-spoiler }}](tp-appel-http_code.md#appel-en-http)
...
----
[{{ site.code-spoiler }}](tp-appel-http_code.md#appel-en-https)
